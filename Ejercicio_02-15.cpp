...
// Problema planteado: Escribir un programa generar un número aleatorio no mayor a dos dígitos y realizar una función para muestre el número en literal. Ejemplo: 34 Treinta y cuatro
